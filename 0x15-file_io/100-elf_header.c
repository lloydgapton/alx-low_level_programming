...
/**
 * print_magic - prints magic number of ELF header file
 * @e_ident: Its a pointer to an array 
 * Descrfiption: Magic numbers
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: A pointer
 */
voud print_data(unsigned char *e_ident)
{
	printf("  Data:                              ");
 ...
 * @e_ident: A pointer to ana array
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
